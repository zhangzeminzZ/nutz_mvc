...
<div class="container">
    <form>
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="person.name" id="name" placeholder="输入名字">
        </div>
        <div class="form-group">
            <label for="age">年龄</label>
            <input type="text" class="form-control" name="person.age" id="age" placeholder="输入年龄">
        </div>
        <div class="form-group">
